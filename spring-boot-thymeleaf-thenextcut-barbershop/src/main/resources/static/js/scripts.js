...
(function($) {
    ...
    $(document).ready(function() {
        ...
        if ((pathname.indexOf("/barbershop/v1/agenda/pessoas/editar/") == 0) || (pathname.indexOf("/barbershop/v1/agenda/pessoas/adicionar") == 0) || (pathname.indexOf("/barbershop/v1/agenda/fornecedores/editar/") == 0) || (pathname.indexOf("/barbershop/v1/agenda/fornecedores/adicionar") == 0)) {
    ...
    $(document).ready(function() {
        if ($('#cliente').val() == null) {
            var pathname = window.location.pathname;
            if (pathname == "/barbershop/v1/calendario/servicos/adicionar") {
    ...
    $("#btn-salvar").on("click",
        function(e) {
            var pathname = window.location.pathname;
            if ((
                    pathname.indexOf("/barbershop/v1/calendario/servicos/editar") == 0 ||
                    pathname.indexOf("/barbershop/v1/calendario/servicos/adicionar") == 0 ||
                    pathname.indexOf("/barbershop/v1/organizacao/estoque/adicionar") == 0 ||
                    pathname.indexOf("/barbershop/v1/organizacao/estoque/editar/") == 0
                ) &&
                $('#valor').val() != "" &&
                $('#data').val() != ""
            ) {
            ...
            } else if ((pathname.indexOf("/barbershop/v1/agenda/pessoas/editar/") == 0 ||
                    pathname.indexOf("/barbershop/v1/agenda/pessoas/adicionar") == 0) &&
                $("#nomePessoa").val() != '' &&
                $("#numeroTelefone").val() != '' &&
                $("#bairro").val() != '' &&
                $("#cidade").val() != '') {
                alert("Dados Salvos com sucesso");
            } else if (pathname.indexOf("/barbershop/v1/organizacao/estoque/adicionar") == 0 &&
                $("#descricaoProduto").val() != '' &&
                $("#valor").val() != '' &&
                $("#data").val() != '') {
                alert("Dados Salvos com sucesso");
            } else if ((pathname.indexOf("/barbershop/v1/agenda/fornecedores/adicionar") == 0 ||
                    pathname.indexOf("/barbershop/v1/agenda/fornecedores/editar/") == 0) &&
                $("#nomeFornecedor").val() != '' &&
                $("#ramoFornecedor").val() != '' &&
                $("#numeroTelefone").val() != '' &&
                $("#bairro").val() != '' &&
    ...
    $(document).ready(function() {
        var pathname = window.location.pathname;
        if (pathname == "/barbershop/v1/organizacao/fluxo-caixa") {
    ...
    $(document).ready(function() {
        var pathname = window.location.pathname;
        if (pathname == "/barbershop/v1/calendario/servicos/hoje") {
    ...
    $(document).ready(function() {
        var pathname = window.location.pathname;
        if (pathname.indexOf("/barbershop/v1/organizacao/estoque/adicionar") == 0 || pathname.indexOf("/salao_arrazus/v1/organizacao/estoque/editar/") == 0 || pathname.indexOf("/barbershop/v1/calendario/servicos/adicionar") == 0 || pathname.indexOf("/barbershop/v1/calendario/servicos/editar/") == 0) {
